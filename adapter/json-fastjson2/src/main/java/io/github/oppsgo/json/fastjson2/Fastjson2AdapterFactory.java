 ...
 * }</pre>
 * Prefer registering this factory once; the shared {@link Fastjson2Adapter} owns a binding cache
 * and should not be replaced with per-request {@code new Fastjson2Adapter()}.
 */
